...
import { User2Icon, Bell, Megaphone, CalendarCheck, FileEdit } from "lucide-react";
...
function Header() {
  ...
  return (
    <header className="bg-slate-200 w-full text-sm border-b border-slate-200">
      ...
      <ul className="absolute right-24 z-10 h-auto w-80 rounded-sm bg-sky-100">
        <li className="p-4 hover:bg-sky-200 cursor-pointer flex items-center gap-4">
          <Megaphone size={22} />
